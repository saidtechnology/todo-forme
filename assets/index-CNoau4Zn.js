...
var D = (e, t, n) =>
  t in e
    ...
    : (e[t] = n);
var E = (e, t, n) => (D(e, typeof t != "symbol" ? t + "" : t, n), n);
(function () {
...
function T() {
  ...
  do {
    ...
    for (y(null), m.length = 0, g = 0; F.length; ) F.pop()();
...
function te(e) {
  const t = [],
    n = [];
  _.forEach((r) => (e.indexOf(r) === -1 ? t.push(r) : n.push(r))),
    n.forEach((r) => r()),
    (_ = t);
}
const b = new Set();
...
function K(e, t, n) {
  ...
  r && r.m(t, n),
    k(() => {
      const i = e.$$.on_mount.map(V).filter(q);
...
function U(e, t, n, r, o, i, l = null, c = [-1]) {
  const d = N;
  y(e);
  const s = (e.$$ = {
    fragment: null,
  ...
  if (
    ((s.ctx = n
      ? n(e, t.props || {}, (a, h, ...u) => {
          const w = u.length ? u[0] : h;
          return (
            s.ctx &&
              o(s.ctx[a], (s.ctx[a] = w)) &&
              (!s.skip_bound && s.bound[a] && s.bound[a](w), v && ie(e, a)),
            h
          );
        })
      : []),
    ...
    if (t.hydrate) {
      const a = Q(t.target);
      s.fragment && s.fragment.l(a), a.forEach(M);
    } else s.fragment && s.fragment.c();
    t.intro && H(e.$$.fragment), K(e, t.target, t.anchor), T();
  }
  y(d);
}
class Y {
...
function ce(e) {
  ...
  return {
    ...
    m(l, c) {
      I(l, t, c), f(t, n), f(t, r), o || ((i = J(t, "click", e[1])), (o = !0));
    },
    p(l, [c]) {
      c & 1 && W(r, l[0]);
    },
...
class ue extends Y {
  constructor(t) {
    super(), U(this, t, fe, ce, B, {});
  }
}
function de(e) {
  let t, n, r, o, i, l, c, d, s, v, a, h;
  return (
    (c = new ue({})),
    {
      c() {
        (t = p("main")),
          (n = p("div")),
          (n.innerHTML = `<a href="https://vitejs.dev" target="_blank" rel="noreferrer"><img src="${ae}" class="logo svelte-wcdx5q" alt="Vite Logo"/></a> <a href="https://svelte.dev" target="_blank" rel="noreferrer"><img src="${le}" class="logo svelte svelte-wcdx5q" alt="Svelte Logo"/></a>`),
          (r = x()),
          (o = p("h1")),
          ...
          (v = x()),
          (a = p("p")),
          (a.textContent = "Click on the Vite and Svelte logos to learn more"),
          j(l, "class", "card"),
          j(a, "class", "read-the-docs svelte-wcdx5q");
      },
      m(u, w) {
        I(u, t, w),
          f(t, n),
